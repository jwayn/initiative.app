<template>
  <div class="bg-gray-100 w-full max-w-3xl mt-4 flex justify-center items-center flex-col">
    ...
    <div v-if="showActorAdd" class="w-full mx-12 sm:max-w-2xl bg-white rounded px-2 px-4 py-4 my-8 shadow">
      ...
      <form class="my-4">
        ...
        <div class="mb-4 flex">
          ...
          <label class="block text-gray-500 text-sm font-bold leading-none" for="initiativeAdvantage">
            NPC?
          </label>
        </div>
        <div class="mb-4">
          <label class="block text-gray-500 text-sm font-bold mb-2" for="characterName">
            Character Name
          </label>
          <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="characterName" type="text" placeholder="Character Name" v-model="actor.characterName">
        </div>

        <div v-if="!actor.npc" class="mb-4">
          <label class="block text-gray-500 text-sm font-bold mb-2" for="playerName">
            Player Name
          </label>
        ...
        <div class="mb-4">
          <label class="block text-gray-500 text-sm font-bold mb-2" for="imageURL">
            Image URL
          </label>
        ...
        <div class="mb-4 flex justify-between">
          <div class="mr-2 sm:w-1/2">
            <label class="block text-gray-500 text-sm font-bold mb-2 leading-none" for="armorClass">
              AC
            </label>
          ...
          <div class="sm:w-1/2">
            <label class="block text-gray-500 text-sm font-bold mb-2 leading-none" for="hitPoints">
              HP
            </label>
        ...
        <div class="mb-4 flex justify-between items-center">
          <div class="mr-2 w-1/2">
            <label class="block text-gray-500 text-sm font-bold mb-2 leading-none" for="initiativeModifier">
              Initiative Modifier
            </label>
        ...
        <div class="mb-4 flex justify-between">
          <div class="mr-2 sm:w-1/2">
            <label class="block text-gray-500 text-sm font-bold mb-2 leading-none" title="Comma separated if multiple classes" for="charClass">
              Class(es)
            </label>
          ...
          <div class="sm:w-1/2">
            <label class="block text-gray-500 text-sm font-bold mb-2 leading-none" for="race">
              Race
            </label>
        ...
        <div class="mb-4 flex justify-between">
          <div class="w-1/2 mr-2">
            <label class="block text-gray-500 text-sm font-bold mb-2 leading-none" for="level">
              Level
            </label>
        ...
        <!-- Attributes -->
        <div class="mb-4">
          <p class="text-gray-600 text-sm font-bold w-full border-b border-gray-300 mb-3">Attributes</p>

          <div class="flex justify-between mb-2">
            <div class="w-1/2 mr-2">
              <label class="block text-gray-500 text-sm font-bold mb-2 leading-none" for="strength">
                STR
              </label>
            ...
            <div class="w-1/2 mr-2">
              <label class="block text-gray-500 text-sm font-bold mb-2 leading-none" for="dexterity">
                DEX
              </label>
            ...
            <div class="w-1/2">
              <label class="block text-gray-500 text-sm font-bold mb-2 leading-none" for="constitution">
                CON
              </label>
          ...
          <div class="flex justify-between">
            <div class="w-1/2 mr-2">
              <label class="block text-gray-500 text-sm font-bold mb-2 leading-none" for="intelligence">
                INT
              </label>
            ...
            <div class="w-1/2 mr-2">
              <label class="block text-gray-500 text-sm font-bold mb-2 leading-none" for="wisdom">
                WIS
              </label>
            ...
            <div class="w-1/2">
              <label class="block text-gray-500 text-sm font-bold mb-2 leading-none" for="charisma">
                CHA
              </label>
        ...
        <!-- Passives -->
        <div class="mb-4">
          <p class="text-gray-600 text-sm font-bold w-full border-b border-gray-300 mb-3">Passives</p>

          <div class="flex justify-between mb-2">
            <div class="w-1/2 mr-2">
              <label class="block text-gray-500 text-sm font-bold mb-2 leading-none" for="passivePerception">
                Perception
              </label>
            ...
            <div class="w-1/2 mr-2">
              <label class="block text-gray-500 text-sm font-bold mb-2 leading-none" for="passiveInvestigation">
                Investigation
              </label>
            ...
            <div class="w-1/2">
              <label class="block text-gray-500 text-sm font-bold mb-2 leading-none" for="passiveInsight">
                Insight
              </label>
        ...
        <div class="w-full flex justify-center mt-8">
          <button @click.prevent="createActor" class="bg-green-700 rounded text-white px-2 py-1 w-64">
            Add
          </button>
        </div>
      </form>
    ...
    <!-- Actor list -->
    <div v-if="!savedActorsLoading">
      <div v-if="savedActors.length > 0">
        <div v-for="actor in savedActors" :key="actor.id">
          {{actor.actor_name}}
        </div>
      </div>
...
export default {
  ...
  methods: {
    createActor: function() {
      this.$store.dispatch('saveActor', this.actor).then(() => {
